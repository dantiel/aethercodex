...
module HorologiumAeternum
  ...
  def self.file_read_fail(path, error_message, _range = nil)
  ...
  def self.processing(message)
    send_status('processing', { message: message.to_s })
  end
  ...
  def task_created(title, plan, max_steps, task_id)
  ...
  def self.task_started(task_id, title, max_steps)
  ...
  def self.task_updated(task_id, title: nil, plan: nil, progress: nil, max_steps: nil)
  ...
  def self.task_completed(task_id, title, duration)
